...
layers = plot(
    ...
    layers = {
            ...
            'green': {'tags': {'landuse': ['grass', 'village_green', 'allotments'], 'natural': ['island', 'wood'], 'leisure':'garden'}},
            'forest': {'tags': {'landuse': 'forest', 'leisure': 'park'}},
        ...
        drawing_kwargs = {
            ...
            'green': {'fc': '#009933', 'ec': '#2F3737', 'lw': 1, 'zorder': 4},
            'forest': {'fc': '#64B96A', 'ec': '#2F3737', 'lw': 1, 'zorder': 4},
            'water': {'fc': '#3399FF', 'ec': '#3399FF', 'hatch': 'ooo...', 'hatch_c': '#85c9e6', 'lw': 1, 'zorder': 2},
            #'parking': {'fc': '#0033CC', 'ec': '#2F3737', 'lw': 1, 'zorder': 1},
            'streets': {'fc': '#2F3737', 'ec': '#475657', 'alpha': 1, 'lw': 0, 'zorder': 2},
            #'building': {'palette': ['#FFC857', '#E9724C', '#C5283D'], 'ec': '#2F3737', 'lw': .5, 'zorder': 4},
            'building': {'fc': '#F2F4CB', 'ec': '#2F3737', 'lw': .5, 'zorder': 2},
        }
)

plt.savefig('Onlygreenforesttoplayer.png')